  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <p class="description"> Default Top-level domain for the generated emails. By default we use ".com". </p>
      </td>
    </tr>
    <tr>
      <th scope="row">
      ...
      <td>
        ...
        <p class="description"> Max amount of blog posts shown on the "Add New" Page. </p>
      </td>
    </tr>
    <tr>
      <th scope="row">
      ...
      <td>
        ...
        <p class="description"> Max amount of blog posts that we fetch when using "Spread comments randomly" option. Default is 9999. </p>
      </td>
    </tr>
    <tr>
      <th scope="row">
...
?> </select>
        <p class="description"> By default all comments generated are approved. You can change it to "Pending" status if you want more control. </p>
      </td>
    </tr>
  </tbody>
</table>
